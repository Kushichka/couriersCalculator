...
export class Dpd {
    ...
    calculatePrice(weight, dimensionA, dimensionB, dimensionC) {
        ...
        switch (true) {
            ...
            // weight check (10 - 15)
            case w > 10 && w <= 15:
                return { name: this.name.weightFrom10To15, price: this.price.weightFrom10To15, colors: this.colors };

            // weight check (15 - 20)
            case w > 15 && w <= 20:
                return { name: this.name.weightFrom15To20, price: this.price.weightFrom15To20, colors: this.colors };

            // weight check (20 - 25)
            case w > 20 && w <= 25:
                return { name: this.name.weightFrom20To25, price: this.price.weightFrom20To25, colors: this.colors };

            // weight check (25 - 31.5)
            case w > 25 && w <= 31.5:
                return { name: this.name.weightFrom25To31, price: this.price.weightFrom25To31, colors: this.colors };
