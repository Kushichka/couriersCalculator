...
export class Dhl {
    ...
    calculatePrice(weight, dimensionA, dimensionB, dimensionC) {
        ...
        switch (true) {
            ...
            // weight check (0 - 5)
            case w <= 5:
                return { name: this.name.weightFrom0To5, price: this.price.weightFrom0To5 };
            ...
            // weight check (10 - 20)
            case w > 10 && w <= 20:
                return { name: this.name.weightFrom10To20, price: this.price.weightFrom10To20 };

            // weight check (5 - 10)
            case w > 20 && w <= 31.5:
                return { name: this.name.weightFrom20To31, price: this.price.weightFrom20To31 };
