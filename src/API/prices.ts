...
export const prices: IPrices = {
    ...
    dpd: {
        ...
        WEIGHT_FROM_0_TO_2_CUSTOM: { standard: "8,74", onDelivery: "Brak" },
        WEIGHT_FROM_2_TO_5_CUSTOM: { standard: "9,26", onDelivery: "Brak" },
        WEIGHT_FROM_5_TO_10_CUSTOM: { standard: "10,06", onDelivery: "Brak" },
        WEIGHT_FROM_10_TO_15_CUSTOM: { standard: "10,61", onDelivery: "Brak" },
        WEIGHT_FROM_15_TO_20_CUSTOM: { standard: "10,96", onDelivery: "Brak" },
        WEIGHT_FROM_20_TO_25_CUSTOM: { standard: "11,86", onDelivery: "Brak" },
        WEIGHT_FROM_25_TO_31_CUSTOM: { standard: "12,86", onDelivery: "Brak" },
        WEIGHT_FROM_31_TO_40_CUSTOM: { standard: "30,35", onDelivery: "Brak" },
        WEIGHT_FROM_40_TO_50_CUSTOM: { standard: "35,35", onDelivery: "Brak" },
    },
    pocztex: {
        ...
        POCZTEX_2XL_CUSTOM: { standard: "Brak", onDelivery: "Brak" },
    },
    schenker: {
        CHECK_PRICE: {
